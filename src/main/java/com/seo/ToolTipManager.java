...
public class ToolTipManager implements Runnable
{
   ...
   */
  public static void setToolTipText(Object obj, Component component, String tip)
  {
    singleton.componentToTipTable.put(component, tip);
    component.addMouseListener((Chess) obj);
  }
   ...
   * @param component the Component
   */
  public static void removeToolTipText(Object obj, Component component)
  {
    singleton.componentToTipTable.remove(component);
    component.removeMouseListener((Chess) obj);
  }
